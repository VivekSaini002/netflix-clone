...
//        }
//
//        // Optional token via query param (media streaming)
//        String uri = request.getRequestURI();
//        if ((uri.contains("/api/files/video/") || uri.contains("/api/files/image/"))
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	private void setAuthenticationInContext(HttpServletRequest request, UserDetails userDetails) {
		UsernamePasswordAuthenticationToken authenticatinToken =
				new UsernamePasswordAuthenticationToken(userDetails, null, userDetails.getAuthorities());
		authenticatinToken.setDetails(new WebAuthenticationDetailsSource().buildDetails(request));
		SecurityContextHolder.getContext().setAuthentication(authenticatinToken);
